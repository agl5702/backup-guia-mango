...
class PlagaView(viewsets.ModelViewSet):
    ...
    def obtener_recomendaciones(self, plaga):
        recomendaciones = {
            ...
            "malformación": "1. Eliminar y destruir flores y brotes deformados al detectarlos para reducir la propagación de la malformación a otros brotes sanos. 2. Mantener una adecuada higiene en el huerto retirando restos vegetales cercanos al árbol, los cuales pueden albergar agentes causantes de malformación.",
